...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="../ingatlaClass.js"></script>
        ...
        <div id="ujAdatForm">
            <form>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input id="hirdetesDatuma" type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" />
                    
                </div>

                <div class="form-group col-md-6">
                <label for="exampleFormControlSelect2">Ingatlan leírása</label>
                ...
                <div class="form-group col-md-6">
                    ...
                    <button type="button" class="btn btn-primary" id="uj">Küldés</button>
